...
/**
 * Footer Component - Site footer with links, contact, social
 */
const Footer = () => {
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-center md:text-left">
              ...
              <p className="text-primary-100 text-sm mt-1">Get updates on new arrivals and exclusive offers</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="inline-block">
              <h2 className="text-2xl font-bold text-white">STYLO7</h2>
              <p className="text-sm text-gray-400 mt-1">Men's Bottom Wear</p>
            </Link>
            <p className="text-sm text-gray-400 mt-4">
              Premium quality track pants, joggers, shorts, and trousers for the modern man.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>448 Sai Paradise Colony,<br />Indore – 452012, MP</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+917974808989" className="hover:text-white">+91-7974808989</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:stylo7india@gmail.com" className="hover:text-white">stylo7india@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {currentYear} STYLO7. All rights reserved.
          </p>
            ...
            <div className="flex gap-2">
              {footerLinks.legal.map((link, idx) => (
                <span key={link.path} className="flex items-center">
                  <Link to={link.path} className="text-sm text-gray-400 hover:text-white">
                    {link.name}
                  </Link>
                  {idx < footerLinks.legal.length - 1 && <span className="text-gray-600 mx-2">|</span>}
                </span>
              ))}
            </div>
          </div>
